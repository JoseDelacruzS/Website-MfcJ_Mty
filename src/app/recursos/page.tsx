...
export default function RecursosPage() {
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col overflow-x-hidden">
      <div className="h-120 w-full rounded-md relative flex flex-col items-center justify-center antialiased xs:-pb-2">
      ...
      <section className="py-16 px-6 text-center border-t border-neutral-800 bg-black/20 ">
