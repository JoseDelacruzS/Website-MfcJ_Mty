...
interface BackgroundBeamsProps {
  className?: string;
  // Nuevas props para controlar los colores
  gradientStart?: string;  // Color inicial (el que aparece)
  gradientVia?: string;    // Color intermedio
  gradientEnd?: string;    // Color final (el que se desvanece)
}
        ...
        >
          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                {/* AQUI SE USAN LOS COLORES PERSONALIZADOS */}
                <stop stopColor={gradientStart} stopOpacity="0"></stop>
                <stop stopColor={gradientStart}></stop>
                <stop offset="32.5%" stopColor={gradientVia}></stop>
                <stop offset="100%" stopColor={gradientEnd} stopOpacity="0"></stop>
              </motion.linearGradient>
            ))}
